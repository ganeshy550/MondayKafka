...
public class MatchService {
    ...
    public void updatePlayerStats(String playerId, String teamId, int runsScored, int wicketsTaken) {
        try {
            // Create PlayerStats object
            PlayerStats stats = new PlayerStats(playerId, teamId, runsScored, wicketsTaken);
